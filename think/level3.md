...
능지테스트 : 8명이 뽕족에서 160,000원을 사용했다. 이때 2명은 술을 마시지 않고 나머지 6명이 소주한병(4,000원)씩 마셔 술값은 총 24,000원이 나왔다. n빵을 하면 20,000원이지만 술을 마시지 않은 2명은 술값을 내게하고 싶지 않다.
2명을 얼마로 고정시켜야 술값을 안낸것으로 할 수 있을까요?